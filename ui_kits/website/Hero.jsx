...
const heroStyles = {
  ...
  atomShell: { position:'relative', width:'min(31vw, 360px)', minWidth:220, aspectRatio:'1 / 1', flex:'0 0 auto', animation:'simaf-atom-settle 2.8s cubic-bezier(0.2, 0.9, 0.18, 1) 3 both', transformOrigin:'50% 50%' },
  atomHalo: { position:'absolute', inset:'8%', borderRadius:'50%', background:'radial-gradient(circle, rgba(0,80,240,0.26) 0%, rgba(0,80,240,0.12) 36%, rgba(0,80,240,0.03) 68%, transparent 100%)', filter:'blur(10px)', animation:'simaf-atom-halo 2.8s ease-out 3 both' },
  atomRingA: { position:'absolute', left:'50%', top:'50%', width:'112%', height:'84%', borderRadius:'50%', border:'1px solid rgba(0,80,240,0.22)', boxShadow:'0 0 0 1px rgba(255,255,255,0.12) inset', animation:'simaf-atom-ring-a 2.8s cubic-bezier(0.2, 0.9, 0.18, 1) 3 both', transformOrigin:'50% 50%' },
  atomRingB: { position:'absolute', left:'50%', top:'50%', width:'88%', height:'118%', borderRadius:'50%', border:'1px solid rgba(184,137,24,0.18)', animation:'simaf-atom-ring-b 2.8s cubic-bezier(0.2, 0.9, 0.18, 1) 3 both', transformOrigin:'50% 50%' },
