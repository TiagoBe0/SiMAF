    ...
    <section className="hero-wrap" style={heroStyles.wrap}>
      <style>{`
        @keyframes simaf-atom-settle {
          ...
          1.2% { transform: translate3d(-14px, 8px, 0) scale(1.07) rotate(8deg); }
          2.4% { transform: translate3d(12px, -10px, 0) scale(0.97) rotate(-7deg); }
          3.6% { transform: translate3d(-11px, -7px, 0) scale(1.04) rotate(5deg); }
          4.8% { transform: translate3d(9px, 11px, 0) scale(0.99) rotate(-4deg); }
          6.2% { transform: translate3d(-6px, 4px, 0) scale(1.02) rotate(2.8deg); }
          7.8% { transform: translate3d(5px, -3px, 0) scale(1.01) rotate(-1.6deg); }
          9.4% { transform: translate3d(-3px, 2px, 0) scale(1.005) rotate(0.8deg); }
          11% { transform: translate3d(1px, -1px, 0) scale(1.002) rotate(-0.35deg); }
          100% { transform: translate3d(0, 0, 0) scale(1) rotate(0deg); }
        }
        @keyframes simaf-atom-halo {
          0% { opacity: 0.2; transform: scale(0.88); }
          2.6% { opacity: 0.46; transform: scale(1.12); }
          6.2% { opacity: 0.26; transform: scale(1.04); }
        ...
        @keyframes simaf-atom-ring-a {
          ...
          2.8% { transform: translate(-50%, -50%) rotate(22deg) scale(1.06); opacity: 0.42; }
          6.8% { transform: translate(-50%, -50%) rotate(-6deg) scale(1.01); opacity: 0.24; }
        ...
        @keyframes simaf-atom-ring-b {
          ...
          3.4% { transform: translate(-50%, -50%) rotate(-14deg) scale(1.08); opacity: 0.32; }
          8% { transform: translate(-50%, -50%) rotate(9deg) scale(1.02); opacity: 0.2; }
